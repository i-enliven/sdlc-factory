...
10. **Client Fidelity Matrix**: When defining a user-facing module (Frontend UI or CLI Tool), dictate the structure exactly. For UI: specify component hierarchy and styling framework to prevent vanilla HTML fallbacks. For CLI: specify command routing, exact argument parsing, and standard output formats.
